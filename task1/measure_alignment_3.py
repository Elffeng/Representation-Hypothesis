...
def get_args():
    ...
    parser.add_argument("--feature_dir", type=str, default="/Users/fengdan/Desktop/essay/platonic-rep-main/results/features/")
...
if __name__ == "__main__":
    args = get_args()
    r_llm_file = os.path.join(args.feature_dir, args.dataset, args.subset,
                              args.left_model_name.replace('/', '_') + '_' + '-avg.pt')
    ...
    llm_rep = load_rep(r_file="/Users/fengdan/Desktop/essay/platonic-rep-main/results/features/multi30k/EleutherAI_pythia-410m_pool-avg.pt")
    lvm_rep = load_rep(r_file="/Users/fengdan/Desktop/essay/platonic-rep-main/results/features/multi30k/vit_giant_patch14_dinov2.lvd142m_pool-cls.pt")
