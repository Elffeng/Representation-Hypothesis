...
def extract_and_save_llm_rep(args, texts, llm_model, tokenizer, ):
    ...
    save_path = utils.to_feature_filename(
        args.output_dir, args.dataset, args.llm_model_name, args.language,
        pool=args.pool,
    )
...
def get_args():
    ...
    parser.add_argument("--llm_model_name", type=str, default="EleutherAI/pythia-410m", choices=["test"])
    # parser.add_argument("--output_dir", type=str, default="/Users/fengdan/Desktop/essay/platonic-rep-main/results/features")
